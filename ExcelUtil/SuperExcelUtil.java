...
import com.zjars.jsdc.dto.ExcelVOAttribute;
 ...
 * @version 1.0
 */
public class SuperExcelUtil<T> {

    private final static String SUFFIX_XLS = "xls";
    private final static String SUFFIX_XLSC = "xlsx";

    Class<T> clazz;

    public SuperExcelUtil(Class<T> clazz) {
        this.clazz = clazz;
    }
            ...
            if (rows > 0) {
                ...
                for (int i = 1; i < rows; i++) {
                    ...
                    for (int j = 0; j < cellNum; j++) {
                        ...
                        /**
                         * 这段代码用于解析excel里的数字，因为excel中"1"在poi里会变成"1.0"
                         */
//                        Cell cell = null;//单元格
...
//                        }
                        ...
                        if (String.class == fieldType) {
                            ...
                            field.set(entity, new Double(c).intValue());
     ...
     * @return 设置好的sheet.
     */
    public static HSSFSheet setHSSFValidation(
            HSSFSheet sheet,
            String[] textlist,
            int firstRow,
            int endRow,
    ...
    private Workbook getWorkBook(MultipartFile file) {
        ...
        try {
            ...
            }else if(fileName.endsWith(SUFFIX_XLSC)){
                //2007
